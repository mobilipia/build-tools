...
class Generate(object):
    def __init__(self, app_config_file, **kw):
        ...
        '''
        with open(app_config_file) as app_config:
    ...
    def firefox(self, target_dir, user_dir):
        ...
        with open(overlay_filename) as overlay_f:
        ...
        for bg_filename in background_files:
            ...
            with open(bg_filename) as bg_file:
                all_bg_files.write('\n'+bg_file.read())
        ...
        with open(overlay_filename, 'w') as out_file:
